...
Purpose: a compact, no-post evaluation ladder for deciding whether Hermes PR Review is worth letting speak on GitHub. Posting mechanics use the repository-specific checklist in [`docs/TESTING.md`](../../docs/TESTING.md#posting-canary); this matrix is about review quality.
