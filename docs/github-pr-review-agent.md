...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](../README.md#5-plan-and-create-the-github-webhook) — GitHub pushes events to Hermes instantly when PRs are opened or updated.
:::
...
- **[Webhook-Based PR Reviews](../README.md#5-plan-and-create-the-github-webhook)** — get instant reviews when PRs are opened (requires a public endpoint)
